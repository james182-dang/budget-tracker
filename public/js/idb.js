...
// This function will be executed if we attempt to submit a budget update and there's no internet connection
...
function uploadBudget() {
    ...
    // upon successful getAll execution, run thi sfunction
